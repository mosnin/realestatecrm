...
const securityHeaders = [
  ...
  // notifications, confirm the report-only console is clean, then swap the key.
  {
    ...
    value: [
      "default-src 'self'",
      "script-src 'self' 'unsafe-inline' https://js.stripe.com https://*.clerk.accounts.dev https://*.clerk.com https://challenges.cloudflare.com https://assets.calendly.com https://maps.googleapis.com https://connect.facebook.net https://analytics.tiktok.com https://www.googletagmanager.com https://www.google-analytics.com https://static.ads-twitter.com https://snap.licdn.com https://sc-static.net https://cdn.amplitude.com https://www.chatbase.co",
