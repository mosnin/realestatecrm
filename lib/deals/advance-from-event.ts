...
/** Buyer / rental are the cycle-1 default boards. Seller is inferred from
 *  contact.leadType when a seller board already exists — we do not bootstrap
 *  a third pipeline here (that lives on honesty PR #568). */
type DefaultPipelineType = 'rental' | 'buyer' | 'seller';
