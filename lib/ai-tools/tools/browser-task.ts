...
export const browserTaskTool = defineTool<typeof parameters, BrowserTaskResult>({
  ...
  riskLevel: 'high',
  description:
    "Research one public-web goal in up to 10 browser steps; uses the realtor's paired browser when connected or an anonymous cloud research browser when enabled, and pauses before any submit, send, payment, or data-changing action.",
  parameters,
