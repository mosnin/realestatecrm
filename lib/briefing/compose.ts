 ...
 * agent's pending AgentDraft rows; `hubspot` (Phase D1) reads the
 * realtor's connected HubSpot CRM for closedate mismatches, stage
 * advances, and new contacts not yet in Chippi. Gmail / Calendar-Google /
 * Slack follow as separate sources. The composer needs no change as
 * the list grows.
 */
