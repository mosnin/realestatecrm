...
export function FloatingChatWidget() {
  ...
  return (
    <div className="fixed bottom-24 right-6 z-50 flex flex-col items-end gap-4 md:bottom-6">
      <AnimatePresence>
        {isOpen && (
          <motion.div
            key="chat-window"
            ...
            animate="visible"
            exit="exit"
            className="w-[92vw] max-w-[380px] overflow-hidden rounded-2xl border border-border/40 bg-background/60 shadow-2xl backdrop-blur-xl ring-1 ring-white/10"
          >
            ...
            <div className="border-b border-border/40 p-3">
              <Select value={selectedAgent} onValueChange={setSelectedAgent}>
                <SelectTrigger className="h-auto w-full cursor-pointer border-none bg-transparent px-2 py-4 text-base font-medium shadow-none hover:bg-transparent focus:ring-0 focus:ring-offset-0">
