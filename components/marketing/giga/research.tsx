...
/**
 * ResearchSection — a light/dark-adaptive "case study" block, reframed as the
 * research story: how Chippi was built on comprehensive real-estate research.
 * "Learn more" points to /research (a stub for now).
 */
    ...
    <section className="px-5 py-24 sm:px-8 sm:py-32 lg:px-10">
      <div className="mx-auto w-full max-w-[1728px]">
        <motion.div {...reveal} transition={{ duration: 0.7, ease: EASE_OUT }}>
          ...
          <h2 className="mt-5 max-w-3xl text-[clamp(1.875rem,3.4vw,3.25rem)] leading-[1.07] tracking-[-0.02em] text-neutral-900 dark:text-white">
        ...
        <motion.div
          ...
          className="mt-12 overflow-hidden rounded-3xl border border-black/10 bg-neutral-50 dark:border-white/10 dark:bg-white/[0.02]"
        >
          <div className="grid lg:grid-cols-2">
            ...
            <div className="flex flex-col justify-center p-8 sm:p-12">
              ...
              <h3 className="mt-3 text-[22px] font-medium leading-snug text-neutral-900 dark:text-white sm:text-[26px]">
              ...
              <p className="mt-7 max-w-md text-[14px] leading-relaxed text-neutral-600 dark:text-white/55">
