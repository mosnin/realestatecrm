 ...
 *
 * A closing CTA block (big thin serif sign-off + white pill) over a hairline
 * rule, then link columns and a meta row, all on near-black. Copy is Chippi/
 * real-estate. Replaces the old pastel footer for the redesigned marketing site.
 */

import Link from 'next/link';
import { BlurRise, Eyebrow, Mono, PillPrimary, PillGhost, Serif } from './primitives';
      ...
      <div className="mx-auto max-w-6xl px-5 py-24 sm:px-8 sm:py-32">
        <BlurRise>
          <div className="flex flex-col items-center text-center">
            ...
            <Serif className="mt-6 max-w-2xl text-[2.5rem] leading-[1.05] text-white sm:text-[3.5rem]">
        ...
        <div className="mx-auto max-w-6xl px-5 py-14 sm:px-8">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4">
            ...
            {Object.entries(columns).map(([heading, items]) => (
              <div key={heading}>
                <Mono className="text-[11px] text-white/40">{heading}</Mono>
