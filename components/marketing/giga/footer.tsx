...
/**
 * SiteFooter — light/dark-adaptive footer with the twirling shader-gradient band
 * on top, then the Chippi wordmark, link columns, and a meta row. Logo swaps
 * black/white with the theme.
 */
...
export function SiteFooter() {
  return (
    <footer className="relative bg-white dark:bg-[#0a0a0a]">
      ...
      <div className="relative border-t border-black/[0.06] dark:border-white/[0.08]">
        <div className="mx-auto w-full max-w-[1728px] px-5 py-14 sm:px-8 lg:px-10">
          <div className="grid grid-cols-2 gap-8 md:grid-cols-5">
            <div className="col-span-2 md:col-span-2">
              ...
              <p className="mt-5 max-w-xs text-sm leading-relaxed text-neutral-500 dark:text-white/45">
                The AI cowork for real-estate agents and brokerages — the busywork runs itself so the
                hours go to closing.
              </p>
            </div>
          ...
          <div className="mt-14 flex flex-col items-center gap-3 border-t border-black/[0.06] pt-6 dark:border-white/[0.08] sm:flex-row sm:justify-between">
            ...
            <div className="flex items-center gap-5">
              <Link
                href="/status"
                className="inline-flex items-center gap-2 text-xs text-neutral-400 transition-colors hover:text-neutral-700 dark:text-white/40 dark:hover:text-white"
              >
