  ...
  return (
    <section className="mx-auto max-w-7xl px-6 py-24 md:px-8 md:py-32">
      <Stagger className="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-5">
        {STATS.map((s) => (
          <StaggerItem key={s.value}>
            <div className="flex h-full flex-col justify-between rounded-3xl bg-white p-8 ring-1 ring-black/[0.05]">
      ...
      <Reveal className="mt-5">
        <div className="relative overflow-hidden rounded-[2rem] bg-[#0c0d10] p-8 md:p-14">
          <div className="flex flex-col gap-8 md:flex-row md:items-end md:justify-between">
            ...
            <div className="shrink-0 text-right">
              ...
              <div className="text-[clamp(3.5rem,9vw,6rem)] font-bold leading-none tracking-tight text-[#ff964f]">
                6 → 1
              </div>
