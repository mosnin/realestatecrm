...
const STATUSES = [
  ...
  { key: 'tour_scheduled', label: 'Tour Scheduled', icon: CalendarCheck, color: 'bg-foreground/[0.06] text-foreground' },
  ...
  { key: 'waitlisted', label: 'Waitlisted', icon: Clock, color: 'bg-foreground/[0.06] text-foreground' },
