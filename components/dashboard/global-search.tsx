  ...
  return (
    <>
      ...
      <button
        ...
        className="hidden md:flex items-center gap-2 h-8 px-3 rounded-lg border border-border bg-muted/60 hover:bg-muted text-muted-foreground text-xs transition-colors"
      >
        <Search size={12} />
        <span>Search</span>
        <kbd className="ml-1 inline-flex items-center gap-0.5 rounded border border-border bg-background px-1 py-0.5 font-mono text-[10px]">
          ⌘K
        </kbd>
      </button>
