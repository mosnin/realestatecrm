...
const { requireSpaceOwnerMock, rateLimitMock, startWorkSessionMock, userOwnsSpaceMock } = vi.hoisted(() => ({
...
describe('POST /api/ai/realtime-delegate', () => {
  ...
  it('rejects broker-admin access to a managed member space before delegation', async () => {
