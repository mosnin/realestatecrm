...
- **API endpoints:** 313
- **Cron jobs:** 10
- **DB tables:** 101  ·  **RPCs:** 21  ·  **migrations:** 154
...
**RPCs (21):** `book_tour_atomic`, `cleanup_agent_data`, `create_brokerage_with_owner`, `create_space_with_defaults`, `current_user_internal_id`, `ensure_agent_settings_for_space`, `grant_credits`, `match_agent_memory`, `match_documents`, `match_documents_hybrid`, `offboard_brokerage_member`, `purge_credit_rows_for_account`, `refund_credit_txn`, `reorder_deal`, `routine_next_run_at`, `routine_set_next_run`, `search_knowledge_docs`, `spend_credits`, `stamp_brief_enabled_at`, `sync_commission_ledger`, `update_updated_at_column`

**Migrations:** 154 (latest: `20260625000000_purge_credits_on_account_delete.sql`)
